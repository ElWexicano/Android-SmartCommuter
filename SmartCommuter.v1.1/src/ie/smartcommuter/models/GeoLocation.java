...
/**
 * This class stores utility GeoLocation methods.
 * 
 * @author Shane Doyle
 */
public class GeoLocation {
	...
	/**
	 * This method is used to get the distance in kilometres between two points.
	 * 
	 * @param lat1
	 * @param lon1
	 * @param lon2
	...
	public static Double distanceBetweenPoints(double lat1, double lon1,
		...
		double distance = Constants.EARTH_RADIUS
				* Math.acos(Math.sin(lat1) * Math.sin(lat2) + Math.cos(lat1)
						* Math.cos(lat2) * Math.cos(lon2) - Math.cos(lon1));
